    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
                ...
                />
                {errors.password && <div className="text-red-500 dark:text-red-300 mt-1">{errors.password}</div>}
            </div>
            ...
            <div>
                ...
                />
                {errors.password_confirmation && <div className="text-red-500 dark:text-red-300 mt-1">{errors.password_confirmation}</div>}
            </div>
            ...
            <div>
                ...
                {errors.role_id && <div className="text-red-500 dark:text-red-300 mt-1">{errors.role_id}</div>}
            </div>
