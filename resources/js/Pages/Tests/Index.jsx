                        ...
                        <table className="w-full border-collapse border border-gray-300 dark:border-gray-700 mt-4">
                            <thead>
                                <tr className="bg-gray-100 dark:bg-gray-700">
                                    ...
                                    <th className="border p-2 text-gray-800 dark:text-gray-200">Values</th>
                                    <th className="border p-2 text-gray-800 dark:text-gray-200">Value Options</th>
                            ...
                            <tbody>
                                {tests.length > 0 ? tests.map((test) => (
                                    <tr key={test.id} className="text-center bg-white dark:bg-gray-800">
                                        ...
                                        <td className="border p-2 text-gray-800 dark:text-gray-200">{test.values}</td>
                                        <td className="border p-2 text-gray-800 dark:text-gray-200">{test.value_options}</td>
                                    ...
                                    <tr>
                                        <td colSpan="7" className="border p-2 text-gray-800 dark:text-gray-200">No tests found.</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
